...
//   protoc               v3.20.3
// source: ros2_interfaces/sbai_protos/sbai_protos/rally_request.proto
...
function createBaseRallyRequest(): RallyRequest {
  return { behaviorRequestId: "", participatingRobotIds: [], geoPoint: undefined, rallyPointToleranceM: 0 };
}

export const RallyRequest: MessageFns<RallyRequest> = {
  encode(message: RallyRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.rallyPointToleranceM !== 0) {
      writer.uint32(37).float(message.rallyPointToleranceM);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RallyRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRallyRequest();
  ...
  fromJSON(object: any): RallyRequest {
    return {
  ...
  toJSON(message: RallyRequest): unknown {
    const obj: any = {};
    if (message.behaviorRequestId !== "") {
  ...
  create<I extends Exact<DeepPartial<RallyRequest>, I>>(base?: I): RallyRequest {
    return RallyRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RallyRequest>, I>>(object: I): RallyRequest {
    const message = createBaseRallyRequest();
