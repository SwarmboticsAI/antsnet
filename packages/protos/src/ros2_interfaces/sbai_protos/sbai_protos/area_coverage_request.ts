...
//   protoc               v3.20.3
// source: ros2_interfaces/sbai_protos/sbai_protos/area_coverage_request.proto
...
export interface AreaCoverageRequest {
...
function createBaseAreaCoverageRequest(): AreaCoverageRequest {
  return { behaviorRequestId: "", participatingRobotIds: [], coverageArea: [], laneWidthM: 0 };
}

export const AreaCoverageRequest: MessageFns<AreaCoverageRequest> = {
  encode(message: AreaCoverageRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.laneWidthM !== 0) {
      writer.uint32(37).float(message.laneWidthM);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AreaCoverageRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAreaCoverageRequest();
  ...
  fromJSON(object: any): AreaCoverageRequest {
    return {
  ...
  toJSON(message: AreaCoverageRequest): unknown {
    const obj: any = {};
    if (message.behaviorRequestId !== "") {
  ...
  create<I extends Exact<DeepPartial<AreaCoverageRequest>, I>>(base?: I): AreaCoverageRequest {
    return AreaCoverageRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AreaCoverageRequest>, I>>(object: I): AreaCoverageRequest {
    const message = createBaseAreaCoverageRequest();
