...
//   protoc               v3.20.3
// source: ros2_interfaces/sbai_network_protos/sbai_network_protos/cell_metrics.proto
...
function createBaseCellMetrics(): CellMetrics {
  return {
    testInternetIp: "",
    minRttMs: 0,
    maxRttMs: 0,
...
export const CellMetrics: MessageFns<CellMetrics> = {
  encode(message: CellMetrics, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CellMetrics {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCellMetrics();
  ...
  fromJSON(object: any): CellMetrics {
    return {
  ...
  toJSON(message: CellMetrics): unknown {
    const obj: any = {};
    if (message.testInternetIp !== "") {
  ...
  create<I extends Exact<DeepPartial<CellMetrics>, I>>(base?: I): CellMetrics {
    return CellMetrics.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CellMetrics>, I>>(object: I): CellMetrics {
    const message = createBaseCellMetrics();
