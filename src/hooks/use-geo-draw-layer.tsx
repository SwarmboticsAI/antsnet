...
// Define a type for our layers to match useBehaviorLayers
 ...
 * @param center Center point as [lng, lat] (DeckGL format)
 * @param radiusM Radius in meters
 * @returns Array of [lng, lat] points forming a circle
 */
...
/**
 * Get appropriate radius based on behavior type and params
 */
...
export function useGeoDrawLayer(): DeckLayer[] {
  ...
  return useMemo(() => {
    ...
    const blueColor: [number, number, number, number] = [100, 149, 237, 200]; // Cornflower blue, similar opacity to behavior orange
    const blueColorFill: [number, number, number, number] = [100, 149, 237, 50]; // Translucent fill
