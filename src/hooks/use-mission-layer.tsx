...
export function useMissionLayer(mission: MissionDraft | null) {
  return useMemo(() => {
    if (!mission) return [];

    const fillRGBA = hexToRgba("#5f93ff", 0.2);
    const strokeRGBA = hexToRgba("#55aaff", 0.9);
    const lineStrokeRBGA = hexToRgba("#f9f9f9", 0.8);
